...
public class Builder {
    ...
    public Builder createConfigureBlock() {
        ...
        if (!configureBlockContents.trim().isEmpty()) {
            builderStringBuffer.append("configure").append(CLOSURE_OPENING_PARENS).append(CHARACTER_SPACING)
                    .append(StringUtils.cleanupParentName(Parser.getProjectType())).append(CHARACTER_SPACING)
                    .append(ROCKET).append(LINE_ENDING);
    ...
    public Builder withStringParameter(final String parameterName) {
        builderStringBuffer.append(METHOD_PARAMETER_STRING_WRAPPER)
                .append(StringUtils.escapeString(parameterName).trim()).append(METHOD_PARAMETER_STRING_WRAPPER)
                .append(METHOD_PARAMETER_SEPARATOR);
        return this;
    }

    public Builder withAttribute(final String attributeName, final String attributeValue) {
        builderStringBuffer.append(attributeName).append(COLON).append(METHOD_PARAMETER_STRING_WRAPPER)
                .append(StringUtils.escapeString(attributeValue)).append(METHOD_PARAMETER_STRING_WRAPPER)
                .append(METHOD_PARAMETER_SEPARATOR);
        return this;
    }

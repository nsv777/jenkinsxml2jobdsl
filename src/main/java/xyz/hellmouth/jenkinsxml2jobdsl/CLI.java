...
public class CLI {
    ...
    /**
     * Parse the command line args specified by the user. If the args are invalid the usage dialogue is printed.
     * Otherwise, attempt to convert a project based on the command line flags specified by the user
     * 
     * @param args
    ...
    /**
     * If the help flag has been specified, print the usage dialogue. Otherwise, convert a project based on the command
     * line arguments specified by the user
     * 
    ...
    private void processCommandLineArgs(final String[] args)
            throws ParseException, FileNotFoundException, JAXBException {
    ...
    private void printUsage() {
        out.println(
                "java -jar jenkins2dsl.jar [-u username -a api-token] -j instance [-p port] [-r project] job1 job2 ...");
        System.exit(0);
    }

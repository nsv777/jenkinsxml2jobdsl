...
public class Parser {
    ...
    public static final List<String> PROJECT_TYPES = Arrays.asList(FREESTYLE_PROJECT_TYPE, MATRIX_PROJECT_TYPE,
            MAVEN_PROJECT_TYPE, MULTI_JOB_PROJECT_TYPE, PIPELINE_PROJECT_TYPE);
    ...
    private static void configureUnmarshaller(final Unmarshaller unmarshaller) throws JAXBException {
        unmarshaller.setEventHandler(new ValidationEventHandler() {
            ...
            public boolean handleEvent(ValidationEvent validationEvent) {
                Meta.extractUnsupportedTagNameAndStoreLongName(validationEvent.getMessage(),

...
public class CCMThresholds implements Buildable {
    ...
    public void build(Builder builder) {
        ...
        builder.with("\n\tunstableTotal: [").with("all: " + unstableTotalAll + ", ")
                .with("high: " + unstableTotalHigh + ", ").with("normal: " + unstableTotalNormal + ", ")
                .with("low: " + unstableTotalLow + "],");
        builder.with("\tfailedTotal: [").with("all: " + failedTotalAll + ", ").with("high: " + failedTotalHigh + ", ")
                .with("normal: " + failedTotalNormal + ", ").with("low: " + failedTotalLow + "],");
        builder.with("\tunstableNew: [").with("all: " + unstableNewAll + ", ").with("high: " + unstableNewHigh + ", ")
                .with("normal: " + unstableNewNormal + ", ").with("low: " + unstableNewLow + "],");
        builder.with("\tfailedNew: [").with("all: " + failedNewAll + ", ").with("high: " + failedNewHigh + ", ")
                .with("normal: " + failedNewNormal + ", ").with("low: " + failedNewLow + "]");
        builder.endMethod();
    }

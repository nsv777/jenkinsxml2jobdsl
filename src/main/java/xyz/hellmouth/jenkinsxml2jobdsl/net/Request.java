...
public class Request {
     ...
     * @param jobName
     */
    public static void fetchConfigXML(final String server, final String username, final String apiToken,
            final String port, final String projectName, final String jobName) {
     ...
     * @return
     */
    private static String buildLocation(final String server, final String port, final String projectName,
